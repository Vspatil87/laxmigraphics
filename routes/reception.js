...
router.get('/reception', function (req, res, next) {
    knex('customer').select('*').then(cresult => {
        knex('category').select('*').then(presult => {
            res.render('reception', { cresult: cresult, presult: presult, title: 'Laxmi Graphics' });
        })
    })
});

// -------------------------------------------reception customer inquiry --------------------------------------------------------------------
...
// -------------------------------------------reception product inquiry --------------------------------------------------------------------

router.post('/reception_product', function (req, res, next) {
